...
[![Release](https://img.shields.io/github/v/release/hakanlundvall/ZenohX?style=flat-square&color=blue)](https://github.com/hakanlundvall/ZenohX/releases)
[![Downloads](https://img.shields.io/github/downloads/hakanlundvall/ZenohX/total?style=flat-square&color=blue)](https://github.com/hakanlundvall/ZenohX/releases)
[![License](https://img.shields.io/badge/license-Apache--2.0-blue?style=flat-square)](LICENSE)
[![Platform](https://img.shields.io/badge/platforms-macOS%20%7C%20Windows%20%7C%20Linux-lightgrey?style=flat-square)](https://github.com/hakanlundvall/ZenohX/releases)
[![Tauri](https://img.shields.io/badge/built%20with-Tauri%20v2-24C8D8?style=flat-square&logo=tauri)](https://tauri.app)

[**Download ZenohX**](https://github.com/hakanlundvall/ZenohX/releases/latest) • [**Features**](#features) • [**Installation**](#installation) • [**Building from Source**](#building-from-source) • [**AI Control (MCP)**](#-ai-control-via-model-context-protocol-mcp) • [**Contributing**](#contributing)
...
Download pre-packaged installers directly from [**GitHub Releases**](https://github.com/hakanlundvall/ZenohX/releases/latest):
...
```bash
# 1. Clone repository
git clone https://github.com/hakanlundvall/ZenohX.git
cd ZenohX
...
- **🐛 Report a Bug:** Open an issue with our [Bug Report Template](https://github.com/hakanlundvall/ZenohX/issues/new?template=bug_report.yml).
- **💡 Suggest a Feature:** Propose ideas using our [Feature Request Template](https://github.com/hakanlundvall/ZenohX/issues/new?template=feature_request.yml).
- **💬 Discussions:** Join our community on [GitHub Discussions](https://github.com/hakanlundvall/ZenohX/discussions).

        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          {form.preset === 'router' && (
            <RouterConfigForm
              ...
              upstreamEndpoints={form.routerUpstreamEndpoints}
              addUpstreamEndpoint={form.addRouterUpstreamEndpoint}
              updateUpstreamEndpoint={form.updateRouterUpstreamEndpoint}
              removeUpstreamEndpoint={form.removeRouterUpstreamEndpoint}
              username={form.username}
              setUsername={form.setUsername}
              password={form.password}
              setPassword={form.setPassword}
